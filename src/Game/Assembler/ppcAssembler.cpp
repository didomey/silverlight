...
struct PPCAssemblerContext {
    ...
    std::vector<ppcAssemblerStr_t> listOperandStr;
    const struct PPCInstructionDef *iDef;
    uint32 opcode;
};
...
public:
    ...
    bool AssembleOperand(PPCAssemblerContext *assemblerCtx, const PPCInstructionDef *iDef, uint32 &opcode,
                         size_t index) const {
    ...
    void DisassembleOperand(PPCDisassembledInstruction *disInstr, const PPCInstructionDef *iDef, const uint32 opcode,
                            size_t index) const {
...
public:
    ...
    bool AssembleOperand(PPCAssemblerContext *assemblerCtx, const PPCInstructionDef *iDef, uint32 &opcode,
        ...
        if (regIndex < 0 || regIndex >= 32) {
            ppcAssembler_setError(assemblerCtx->ctx,
...
public:
    ...
    bool AssembleOperand(PPCAssemblerContext *assemblerCtx, const PPCInstructionDef *iDef, uint32 &opcode,
        ...
        if (endPtr == startPtr || endPtr[-1] != ')') {
            ppcAssembler_setError(assemblerCtx->ctx, fmt::format(
                    "\'{}\' does not end with valid memory register syntax. Memory operand must have the form offset(gpr). Example: 0x20(r3)",
                    svOpText));
            return false;
        }
        endPtr--;
        ...
        try {
            if (ep.IsConstantExpression(svExpressionPart)) {
                ...
                assemblerCtx->ctx->list_relocs.emplace_back(PPCASM_RELOC::U32_MASKED_IMM, std::string(svExpressionPart),
                                                            0, 0, 16);
                return true;
            }
        }
...
public:
    EncodedOperand_IMM(uint8 bitPos, uint8 bits, bool isSigned, bool negate = false, bool extendedRange = false)
            : m_bitPos(bitPos), m_bits(bits), m_isSigned(isSigned), m_negate(negate), m_extendedRange(extendedRange) {}
    ...
    bool AssembleOperand(PPCAssemblerContext *assemblerCtx, const PPCInstructionDef *iDef, uint32 &opcode,
        ...
        try {
            if (ep.IsConstantExpression(expressionString)) {
                ...
                assemblerCtx->ctx->list_relocs.emplace_back(PPCASM_RELOC::U32_MASKED_IMM, expressionString, 0, m_bitPos,
                                                            m_bits);
                return true;
            }
        }
            ...
            std::string msg = fmt::format("\"{}\" could not be evaluated. Error: {}", expressionString.c_str(),
                                          e->what());
            ppcAssembler_setError(assemblerCtx->ctx, msg);
            return false;
        }
...
public:
    ...
    void AssembleConstraint(PPCAssemblerContext *assemblerCtx, const PPCInstructionDef *iDef, uint32 &opcode) const {
    }

    bool DisassembleCheckConstraint(PPCDisassembledInstruction *disInstr, const PPCInstructionDef *iDef,
                                    const uint32 opcode) const {
        return true;
    }
};
...
public:
    EncodedConstraint_MirrorReverseU5(uint8 srcBitPos, uint8 dstBitPos, uint8 invBase) : m_srcBitPos(srcBitPos),
                                                                                         m_dstBitPos(dstBitPos),
                                                                                         m_invBase(invBase) {}
...
public:
    EncodedConstraint_CheckSignBit(uint8 bitPos, uint8 expectedValue) : m_bitPos(bitPos),
...
struct PPCInstructionDef {
    ...
    const std::array<std::variant<EncodedOperand_None, EncodedOperand_GPR<false>, EncodedOperand_GPR<true>, EncodedOperand_FPR, EncodedOperand_SPR, EncodedOperand_IMM, EncodedOperand_U5Reverse, EncodedOperand_MemLoc>, 4> encodedOperands{}; // note: The default constructor of std::variant will default-construct the first type (which we want to be EncodedOperand_None)
    const std::array<std::variant<EncodedConstraint_None, EncodedConstraint_MirrorRegister, EncodedConstraint_MirrorReverseU5, EncodedConstraint_FixedRegister, EncodedConstraint_FixedSPR, EncodedConstraint_CheckSignBit>, 3> constraints{};
};

const PPCInstructionDef ppcInstructionTable[] =
        {
                {PPCASM_OP_PS_MERGE00, 0, 4,  16, 16,                     OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_MERGE01, 0, 4,  16, 17,                     OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_MERGE10, 0, 4,  16, 18,                     OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_MERGE11, 0, 4,  16, 19,                     OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},

                {PPCASM_OP_PS_DIV,     0, 4,  18,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_SUB,     0, 4,  20,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_ADD,     0, 4,  21,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_MUL,     0, 4,  25,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6)}},

                {PPCASM_OP_PS_MSUB,    0, 4,  28,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_MADD,    0, 4,  29,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_NMSUB,   0, 4,  30,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_PS_NMADD,   0, 4,  31,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},

                {PPCASM_OP_MULLI,      0, 7,  OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true)}},

                {PPCASM_OP_SUBFIC,     0, 8,  OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true)}},
                ...
                {PPCASM_OP_ADDIC,      0, 12, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true)}},
                {PPCASM_OP_ADDIC_,     0, 13, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true)}},
                {PPCASM_OP_ADDI,       0, 14, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true)}},
                {PPCASM_OP_SUBI,       1, 14, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true, true)}, {EncodedConstraint_CheckSignBit(15,
                                                                                                     1)}}, // special form of ADDI for negative immediate
                {PPCASM_OP_LI,         1, 14, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_IMM(
                        0, 16, true, false, true)},                  {EncodedConstraint_FixedRegister(16, 0)}},
                {PPCASM_OP_ADDIS,      0, 15, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(0, 16, true, false, true)}},
                {PPCASM_OP_LIS,        1, 15, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_IMM(
                        0, 16, true, false, true)},                  {EncodedConstraint_FixedRegister(16, 0)}},
                ...
                {PPCASM_OP_BNE,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT,
                                                                                                                C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_EQ, nullptr},
                {PPCASM_OP_BEQ,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT, C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_EQ, nullptr},
                {PPCASM_OP_BGE,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT, C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_LT, nullptr},
                {PPCASM_OP_BGT,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT, C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_GT, nullptr},
                {PPCASM_OP_BLT,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT, C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_LT, nullptr},
                {PPCASM_OP_BLE,        1, 16, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S16,      FLG_DEFAULT, C_MASK_BO_COND |
                                                                                                                C_MASK_BI_CRBIT,         C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_GT, nullptr},
                ...
                {PPCASM_OP_B,          0, 18, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S24,      FLG_DEFAULT, C_MASK_LK |
                                                                                                                C_MASK_AA, 0,                             nullptr},
                {PPCASM_OP_BL,         0, 18, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S24,      FLG_DEFAULT, C_MASK_LK |
                                                                                                                C_MASK_AA,               C_BIT_LK,        nullptr},
                {PPCASM_OP_BA,         0, 18, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S24,      FLG_DEFAULT, C_MASK_LK |
                                                                                                                C_MASK_AA,               C_BIT_AA,        nullptr},
                {PPCASM_OP_BLA,        0, 18, OPC_NONE,         OPC_NONE, OP_FORM_BRANCH_S24,      FLG_DEFAULT, C_MASK_LK |
                                                                                                                C_MASK_AA,               C_BIT_LK |
                                                                                                                                         C_BIT_AA,     nullptr},

                {PPCASM_OP_BLR,        0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_LK,               C_BIT_BO_ALWAYS, nullptr},

                {PPCASM_OP_BLTLR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_LT, nullptr}, // less
                {PPCASM_OP_BGTLR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_GT, nullptr}, // greater
                {PPCASM_OP_BEQLR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_TRUE |
                                                                                                                                         C_BITS_BI_EQ, nullptr}, // equal
                {PPCASM_OP_BLELR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_GT, nullptr}, // less or equal (not greater)
                {PPCASM_OP_BGELR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_LT, nullptr}, // greater or equal (not less)
                {PPCASM_OP_BNELR,      0, 19, 16,               OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_BI_CRBIT |
                                                                                                                C_MASK_LK,               C_BIT_BO_FALSE |
                                                                                                                                         C_BITS_BI_EQ, nullptr}, // not equal
                ...
                {PPCASM_OP_BCTR,       0, 19, 528,              OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_LK,               C_BIT_BO_ALWAYS, nullptr},
                {PPCASM_OP_BCTRL,      0, 19, 528,              OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, C_MASK_BO |
                                                                                                                C_MASK_LK,               C_BIT_BO_ALWAYS |
                                                                                                                                         C_BIT_LK,     nullptr},
                ...
                {PPCASM_OP_ROTLWI,     2, 21, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(11, 5, false)},      {EncodedConstraint_FixedU5(6,
                                                                                                0), EncodedConstraint_FixedU5(
                        1, 31)}},
                {PPCASM_OP_ROTLWI_,    2, 21, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(11, 5, false)},      {EncodedConstraint_FixedU5(6,
                                                                                                0), EncodedConstraint_FixedU5(
                        1, 31)}},
                ...
                // only Assembler
                {PPCASM_OP_ROTRWI,     0, 21, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_U5Reverse(11, 32)},      {EncodedConstraint_FixedU5(6,
                                                                                                0), EncodedConstraint_FixedU5(
                        1, 31)}},
                {PPCASM_OP_ROTRWI_,    0, 21, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_U5Reverse(11, 32)},      {EncodedConstraint_FixedU5(6,
                                                                                                0), EncodedConstraint_FixedU5(
                        1, 31)}},
                ...
                {PPCASM_OP_ORI,        0, 24, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, false)}},
                {PPCASM_OP_NOP,        1, 24, OPC_NONE,         OPC_NONE, OP_FORM_NO_OPERAND,      FLG_DEFAULT, 0x3FFFFFF, 0,            nullptr}, // ORI r0, r0, 0 -> NOP
                {PPCASM_OP_ORIS,       0, 25, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, true, false, true)}},

                {PPCASM_OP_XORI,       0, 26, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, false)}},
                {PPCASM_OP_XORIS,      0, 27, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, true, false, true)}},

                {PPCASM_OP_ANDI_,      0, 28, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, false)}},
                {PPCASM_OP_ANDIS_,     0, 29, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_IMM(0, 16, true, false, true)}},
                ...
                {PPCASM_OP_SUBFC,      1, 31, 8,                OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SUBFC_,     1, 31, 8,                OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_MULHWU,     0, 31, 11,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_MULHWU_,    0, 31, 11,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_CMPLW,      0, 31, 32,               OPC_NONE, OP_FORM_OP3_A_CMP,       FLG_DEFAULT, 0,         0,            nullptr},

                {PPCASM_OP_SUBF,       1, 31, 40,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SUBF_,      1, 31, 40,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SUB,        0, 31, 40,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        11), EncodedOperand_GPR(16)}},
                {PPCASM_OP_SUB_,       0, 31, 40,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        11), EncodedOperand_GPR(16)}},

                {PPCASM_OP_MULHW,      0, 31, 75,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_MULHW_,     0, 31, 75,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_NEG,        0, 31, 104,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC |
                                                                                                                C_MASK_OE, 0,                             nullptr, {EncodedOperand_GPR(
                        21), EncodedOperand_GPR(16)}},
                {PPCASM_OP_NEG_,       0, 31, 104,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC |
                                                                                                                C_MASK_OE,               C_BIT_RC,        nullptr, {EncodedOperand_GPR(
                        21), EncodedOperand_GPR(16)}},

                {PPCASM_OP_NOR,        0, 31, 124,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_NOR_,       0, 31, 124,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},

                // alias for NOR where rA == rB
                {PPCASM_OP_NOT,        1, 31, 124,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        11)},                                        {EncodedConstraint_MirrorRegister(11, 21)}},
                {PPCASM_OP_NOT_,       1, 31, 124,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        11)},                                        {EncodedConstraint_MirrorRegister(11, 21)}},

                {PPCASM_OP_SUBFE,      1, 31, 136,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SUBFE_,     1, 31, 136,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_MULLW,      0, 31, 235,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_MULLW_,     0, 31, 235,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_MFSPR,      0, 31, 339,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_SPR()}},
                {PPCASM_OP_MTSPR,      0, 31, 467,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_SPR(), EncodedOperand_GPR(
                        21)}},

                {PPCASM_OP_MFLR,       0, 31, 339,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21)},                                        {EncodedConstraint_FixedSPR(8)}},
                {PPCASM_OP_MTLR,       0, 31, 467,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21)},                                        {EncodedConstraint_FixedSPR(8)}},
                {PPCASM_OP_MFCTR,      0, 31, 339,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21)},                                        {EncodedConstraint_FixedSPR(9)}},
                {PPCASM_OP_MTCTR,      0, 31, 467,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21)},                                        {EncodedConstraint_FixedSPR(9)}},

                {PPCASM_OP_ADD,        0, 31, 266,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_ADD_,       0, 31, 266,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_SLW,        0, 31, 24,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SLW_,       0, 31, 24,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SRW,        0, 31, 536,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SRW_,       0, 31, 536,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SRAW,       0, 31, 792,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_SRAW_,      0, 31, 792,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},

                {PPCASM_OP_AND,        0, 31, 28,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_AND_,       0, 31, 28,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},

                {PPCASM_OP_ANDC,       0, 31, 60,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_ANDC_,      0, 31, 60,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},

                {PPCASM_OP_XOR,        0, 31, 316,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},

                {PPCASM_OP_ORC,        0, 31, 412,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}}, // has RC?
                {PPCASM_OP_OR,         0, 31, 444,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_OR_,        0, 31, 444,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21), EncodedOperand_GPR(11)}},
                {PPCASM_OP_MR,         1, 31, 444,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        11)},                                        {EncodedConstraint_MirrorRegister(11, 21)}},
                {PPCASM_OP_MR_,        1, 31, 444,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        11)},                                        {EncodedConstraint_MirrorRegister(11, 21)}},

                {PPCASM_OP_DIVWU,      0, 31, 459,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_DIVWU_,     0, 31, 459,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_DIVW,       0, 31, 491,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_DIVW_,      0, 31, 491,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_GPR(11)}},
                ...
                {PPCASM_OP_CNTLZW,     0, 31, 26,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},
                {PPCASM_OP_EXTSB,      0, 31, 954,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},
                {PPCASM_OP_EXTSH,      0, 31, 922,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, 0,            nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},

                {PPCASM_OP_CNTLZW_,    0, 31, 26,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},
                {PPCASM_OP_EXTSB_,     0, 31, 954,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},
                {PPCASM_OP_EXTSH_,     0, 31, 922,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        16),                                                                                                                                                  EncodedOperand_GPR(
                        21)}},

                {PPCASM_OP_LWZX,       0, 31, 23,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LWZUX,      0, 31, 55,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LBZX,       0, 31, 87,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LBZUX,      0, 31, 119,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LHZX,       0, 31, 279,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LHZUX,      0, 31, 311,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LHAX,       0, 31, 343,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LHAUX,      0, 31, 375,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STWX,       0, 31, 151,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STWUX,      0, 31, 183,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STHX,       0, 31, 407,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STHUX,      0, 31, 439,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STBX,       0, 31, 215,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STBUX,      0, 31, 247,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STWBRX,     0, 31, 662,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STHBRX,     0, 31, 918,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_LFSX,       0, 31, 535,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LFSUX,      0, 31, 567,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STFSX,      0, 31, 663,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STFSUX,     0, 31, 695,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_STSWI,      0, 31, 725,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR(
                        16), EncodedOperand_IMM(11, 5, false)}},

                {PPCASM_OP_LWARX,      0, 31, 20,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STWCX_,     0, 31, 150,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, C_MASK_RC, C_BIT_RC,     nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_LFDX,       0, 31, 599,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_LFDUX,      0, 31, 631,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STFDX,      0, 31, 727,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},
                {PPCASM_OP_STFDUX,     0, 31, 759,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},

                {PPCASM_OP_STFIWX,     0, 31, 983,              OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_GPR<true>(
                        16), EncodedOperand_GPR(11)}},

                // load/store
                {PPCASM_OP_LWZ,        0, 32, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LWZU,       0, 33, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LBZ,        0, 34, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LBZU,       0, 35, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STW,        0, 36, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STWU,       0, 37, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STB,        0, 38, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STBU,       0, 39, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LHZ,        0, 40, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LHZU,       0, 41, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LHA,        0, 42, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LHAU,       0, 43, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STH,        0, 44, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STHU,       0, 45, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LMW,        0, 46, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STMW,       0, 47, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_GPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LFS,        0, 48, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LFSU,       0, 49, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LFD,        0, 50, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_LFDU,       0, 51, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STFS,       0, 52, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STFSU,      0, 53, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STFD,       0, 54, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},
                {PPCASM_OP_STFDU,      0, 55, OPC_NONE,         OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_MemLoc()}},

                // FP
                {PPCASM_OP_FDIVS,      0, 59, 18,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FSUBS,      0, 59, 20,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FADDS,      0, 59, 21,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FMULS,      0, 59, 25,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6)}},
                {PPCASM_OP_FMSUBS,     0, 59, 28,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FMADDS,     0, 59, 29,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FNMSUBS,    0, 59, 30,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FNMADDS,    0, 59, 31,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},

                {PPCASM_OP_FCMPU,      0, 63, 0,                OPC_NONE, OP_FORM_X_FP_CMP,        FLG_DEFAULT, 0,         0,            nullptr},
                {PPCASM_OP_FCTIWZ,     0, 63, 15,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        11)}},
                {PPCASM_OP_FDIV,       0, 63, 18,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FSUB,       0, 63, 20,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FADD,       0, 63, 21,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FMUL,       0, 63, 25,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6)}},
                {PPCASM_OP_FRSQRTE,    0, 63, 26,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        11)}},
                {PPCASM_OP_FMSUB,      0, 63, 28,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FMADD,      0, 63, 29,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FNMSUB,     0, 63, 30,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FNMADD,     0, 63, 31,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        16), EncodedOperand_FPR(6), EncodedOperand_FPR(11)}},
                {PPCASM_OP_FRSP,       0, 63, 12,               OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        11)}},

                // 63 extended opcode
                {PPCASM_OP_FCMPO,      0, 63, 32 |
                                              OPC_EXTENDED_BIT, OPC_NONE, OP_FORM_X_FP_CMP,        FLG_DEFAULT, 0,         0,            nullptr},
                {PPCASM_OP_FNEG,       0, 63, 40 |
                                              OPC_EXTENDED_BIT, OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        11)}},
                {PPCASM_OP_FMR,        0, 63, 72 |
                                              OPC_EXTENDED_BIT, OPC_NONE, OP_FORM_DYNAMIC,         FLG_DEFAULT, 0,         0,            nullptr,      {EncodedOperand_FPR(
                        21),                                                                                                                                                  EncodedOperand_FPR(
                        11)}},
...
void ppcAssembler_buildOpcMask(const PPCInstructionDef *iDef, uint32 &maskOut, uint32 &bitsOut) {
...
sint32 _getOpIndex(const PPCInstructionDef *iDef, sint32 operandIndex) {
...
void _disasmOpGPR(PPCDisassembledInstruction *disInstr, const PPCInstructionDef *iDef, uint32 operandIndex,
                  sint32 regIndex) {
...
void ppcAssembler_disassemble(uint32 virtualAddress, uint32 opcode, PPCDisassembledInstruction *disInstr) {
    ...
    for (uint32 i = 0; i < sizeof(ppcInstructionTable) / sizeof(PPCInstructionDef); i++) {
        const PPCInstructionDef *iDef = ppcInstructionTable + i;
        // check opcode
        uint32 opcMask;
        uint32 opcBits;
    ...
    if (bestMatchIndex >= 0) {
        const PPCInstructionDef *iDef = ppcInstructionTable + bestMatchIndex;
        ...
        if (iDef->instructionForm == OP_FORM_DYNAMIC) {
            ...
            if ((rS & 3) != 0)
                CAFEWARNING(fmt::format("[PPC-Disassembler] Unexpected CR encoding for instruction 0x{0:08x}",
                                        opcode).c_str());
...
bool _ppcAssembler_processRegisterOperand(PPCAssemblerContext &internalCtx, sint32 operandIndex, sint32 bitIndex,
                                          const char *prefix, const sint32 registerCount) {
    sint32 opTextIdx;
...
bool _ppcAssembler_processCROperand(PPCAssemblerContext &internalCtx, sint32 operandIndex, sint32 bitIndex,
                                    bool isEncodedAsBitIndex) {
    return _ppcAssembler_processRegisterOperand(internalCtx, operandIndex, bitIndex + (isEncodedAsBitIndex ? 2 : 0),
                                                "cr", 8);
}

template<typename TExprResult>
bool _ppcAssembler_evaluateConstantExpression(PPCAssemblerContext &internalCtx, TExpressionParser<TExprResult> &ep,
...
bool _ppcAssembler_processImmediateOperandS16(PPCAssemblerContext &internalCtx, sint32 operandIndex, sint32 bitIndex,
    ...
    try {
        ...
        // check if expression is invalid or if it contains unknown constants
        sprintf(_assemblerErrorMessageDepr, "\'%s\' could not be evaluated. Error: %s", expressionString.c_str(),
                e->what());
        ppcAssembler_setError(internalCtx.ctx, _assemblerErrorMessageDepr);
        return false;
    }
...
bool _ppcAssembler_processImmediateOperandU5(PPCAssemblerContext &internalCtx, sint32 operandIndex, sint32 bitIndex) {
    ...
    try {
        ...
        // check if expression is invalid or if it contains unknown constants
        ppcAssembler_setError(internalCtx.ctx, fmt::format("\'{}\' is not a valid expression",
...
bool _ppcAssembler_processImmediateOperandU5Const(PPCAssemblerContext &internalCtx, sint32 operandIndex, sint8 &value) {
    ...
    if (r < 0 || r >= 32) {
        ppcAssembler_setError(internalCtx.ctx,
                              fmt::format("Expression '\'{0}\' which evaluates to {1} is not in range 0-31", expr, r));
        return false;
    }
    value = (sint8) r;
    return true;
    ...
    for (size_t i = 0; i < elementCount; i++) {
        ...
        if (internalInfo.listOperandStr[i].str.size() >= 1 && expressionStr[0] == '"') {
            if (dataDirective != ASM_DATA_DIRECTIVE::U8) {
                ppcAssembler_setError(internalInfo.ctx,
            ...
            internalInfo.ctx->outputData.insert(internalInfo.ctx->outputData.end(), expressionStr.data() + 1,
        ...
        if (ep.IsConstantExpression(expressionStr)) {
            ...
            internalInfo.ctx->list_relocs.emplace_back(relocType, std::string(internalInfo.listOperandStr[i].str),
                                                       (uint32) (elementPtr - internalInfo.ctx->outputData.data()), 0,
                                                       0);
        }
    }
    return true;
...
bool ppcAssembler_assembleSingleInstruction(char const *text, PPCAssemblerInOut *ctx) {
        ...
        try {
            if (ep.IsConstantExpression(internalInfo.listOperandStr[0].str)) {
                ...
                if (alignmentValue <= 0 || alignmentValue >= 256) {
                    ppcAssembler_setError(ctx,
                                          fmt::format("Alignment value \'{}\' is not within the allowed range (1-256)",
                                                      alignmentValue));
                    return false;
                }
                ...
                ppcAssembler_setError(ctx, fmt::format("Expression \'{}\' for .align directive is not a constant",
                                                       internalInfo.listOperandStr[0].str));
                return false;
            }
        }
        catch (std::exception *e) {
            ppcAssembler_setError(ctx, fmt::format(
    ...
    const PPCInstructionDef *iDef = nullptr;
    for (uint32 i = 0; i < sizeof(ppcInstructionTable) / sizeof(PPCInstructionDef); i++) {
        const PPCInstructionDef *instr = &ppcInstructionTable[i];
    ...
    if (iDef == nullptr) {
        ppcAssembler_setError(ctx,
                              fmt::format("Instruction \'{}\' is unknown or not supported", instructionName.c_str()));
        return false;
    }
    // build opcode
    ...
    if (iDef->instructionForm == OP_FORM_DYNAMIC) {
        ...
        CAFEASSERT(false); // unsupported instruction form
        return false;
    }
...
void _testAsm(uint32 expected, const char *iText) {
    ...
    CAFEASSERT(ctx.outputData.size() == 4);
    uint32 opcode = 0;
...
void _testAsmArray(std::vector<uint8> expectedArray, const char *iText) {
    ...
    CAFEASSERT(ctx.outputData.size() == expectedArray.size());
    for (size_t offset = 0; offset < expectedArray.size(); offset++) {
        CAFEASSERT(ctx.outputData[offset] == expectedArray[offset]);
    }
}

void ppcAsmTestDisassembler() {
    CAFEASSERT(_CanStoreInteger(5, 10, false));
    CAFEASSERT(_CanStoreInteger(1023, 10, false));
    CAFEASSERT(!_CanStoreInteger(1024, 10, false));
    CAFEASSERT(_CanStoreInteger(511, 10, true));
    CAFEASSERT(!_CanStoreInteger(512, 10, true));
    CAFEASSERT(_CanStoreInteger(-511, 10, true));
    CAFEASSERT(_CanStoreInteger(-512, 10, true));
    CAFEASSERT(!_CanStoreInteger(-513, 10, true));
    ...
    auto disassemble = [&](uint32 opcode, PPCASM_OP ppcAsmCode) {
        ...
        CAFEASSERT(disasm.ppcAsmCode == ppcAsmCode);
    };
    ...
    auto checkOperandMask = [&](bool op0 = false, bool op1 = false, bool op2 = false, bool op3 = false) {
        ...
        CAFEASSERT(hasOp0 == op0);
        CAFEASSERT(hasOp1 == op1);
        CAFEASSERT(hasOp2 == op2);
        CAFEASSERT(hasOp3 == op3);
    };

    auto checkOpCR = [&](size_t index, uint8 crIndex) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_CR);
        CAFEASSERT(disasm.operand[index].registerIndex == crIndex);
    };

    auto checkOpCRBit = [&](size_t index, uint8 crIndex) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_CR_BIT);
        CAFEASSERT(disasm.operand[index].registerIndex == crIndex);
    };

    auto checkOpFPR = [&](size_t index, uint8 fprIndex) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_FPR);
        CAFEASSERT(disasm.operand[index].registerIndex == fprIndex);
    };

    auto checkOpGPR = [&](size_t index, uint8 gprIndex) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_GPR);
        CAFEASSERT(disasm.operand[index].registerIndex == gprIndex);
    };

    auto checkOpImm = [&](size_t index, sint32 imm) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_IMM);
        CAFEASSERT(disasm.operand[index].immS32 == imm);
    };

    auto checkOpBranchDst = [&](size_t index, sint32 relOffset) {
        CAFEASSERT(disasm.operand[index].type == PPCASM_OPERAND_TYPE_CIMM);
        CAFEASSERT(disasm.operand[index].immU32 == 0x10000000u + relOffset);
    };

    auto checkBranchHint = [&](bool isSet) {
        CAFEASSERT(disasm.branchHintBitSet == isSet);
    };
