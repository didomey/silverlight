...
namespace Modules {
    NoAutoCameraMovement::NoAutoCameraMovement() {
		this->patchLine(0x02664f20, "nop");
		this->patchLine(0x0269D170, "li r12, 1");
    ...
    bool NoAutoCameraMovement::isCheatModule() {
        return false;
    }

    REGISTERVCLASS(NoAutoCameraMovement)
}
